...
/**
 * Created by churongShaw on 2016/4/3.
 * WIFI DIRECT 广播监听的接收器
 */
public class WifiDirectBroadcastReceiver extends BroadcastReceiver {
    ...
    /**
     * 动态注册时实例化接收器的构造函数。
     * @param manager 通过getSystemService(Context.WIFI_P2P_SERVICE)获取
     * @param channel 通过manager.initialize(this, getMainLooper(), null)获取
     * @param activity 当前界面的Activity对象
